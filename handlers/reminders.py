...
async def handle_list_reminders(update: Update, context: CallbackContext):
    ...
    if not reminders:
        keyboard = [[InlineKeyboardButton("🔙 Назад", callback_data='reminder')]]
        reply_markup = InlineKeyboardMarkup(keyboard)
    ...
    keyboard.append([InlineKeyboardButton("🔙 Назад", callback_data='reminder')])
...
async def handle_view_reminder(update: Update, context: CallbackContext):
    ...
    keyboard.append([InlineKeyboardButton("🔙 Назад до списку", callback_data='list_reminders')])
...
async def handle_complete_reminder(update: Update, context: CallbackContext):
    ...
    if success:
        keyboard = [[InlineKeyboardButton("🔙 Назад до списку", callback_data='list_reminders')]]
        reply_markup = InlineKeyboardMarkup(keyboard)
...
create_reminder_conversation = ConversationHandler(
    entry_points=[CallbackQueryHandler(handle_create_reminder, pattern='^create_reminder$')],
    states={
